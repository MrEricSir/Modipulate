...
UINT HackedCSoundFile::m_nXBassDepth = 6;
UINT HackedCSoundFile::m_nXBassRange = XBASS_DELAY;
UINT HackedCSoundFile::m_nReverbDepth = 1;
UINT HackedCSoundFile::m_nReverbDelay = 100;
UINT HackedCSoundFile::m_nProLogicDepth = 12;
UINT HackedCSoundFile::m_nProLogicDelay = 20;
...
void HackedCSoundFile::InitializeDSP(BOOL bReset)
//-----------------------------------------
{
...
void HackedCSoundFile::ProcessStereoDSP(int count)
//------------------------------------------
{
#ifndef MODPLUG_NO_REVERB
	// Reverb
...
void HackedCSoundFile::ProcessMonoDSP(int count)
//----------------------------------------
{
#ifndef MODPLUG_NO_REVERB
	// Reverb
...
BOOL HackedCSoundFile::SetReverbParameters(UINT nDepth, UINT nDelay)
//------------------------------------------------------------
{
...
BOOL HackedCSoundFile::SetXBassParameters(UINT nDepth, UINT nRange)
//-----------------------------------------------------------
{
	if (nDepth > 100) nDepth = 100;
	UINT gain = nDepth / 20;
...
BOOL HackedCSoundFile::SetSurroundParameters(UINT nDepth, UINT nDelay)
//--------------------------------------------------------------
{
...
BOOL HackedCSoundFile::SetWaveConfigEx(BOOL bSurround,BOOL bNoOverSampling,BOOL bReverb,BOOL hqido,BOOL bMegaBass,BOOL bNR,BOOL bEQ)
//----------------------------------------------------------------------------------------------------------------------------
{
