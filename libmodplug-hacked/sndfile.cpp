...
HackedCSoundFile::HackedCSoundFile()
//----------------------
{
...
BOOL HackedCSoundFile::Create(LPCBYTE lpStream, DWORD dwMemLength)
//----------------------------------------------------------
{
	int i;
	m_nType = MOD_TYPE_NONE;
...
MODCOMMAND *HackedCSoundFile::AllocatePattern(UINT rows, UINT nchns)
//------------------------------------------------------------
{
...
void HackedCSoundFile::FreePattern(LPVOID pat)
//--------------------------------------
{
...
signed char* HackedCSoundFile::AllocateSample(UINT nbytes)
//-------------------------------------------
{
...
void HackedCSoundFile::FreeSample(LPVOID p)
//-----------------------------------
{
	if (p)
	{
...
void HackedCSoundFile::ResetMidiCfg()
//-----------------------------
{
...
UINT HackedCSoundFile::GetNumChannels() const
//-------------------------------------
{
	UINT n = 0;
...
UINT HackedCSoundFile::GetSongComments(LPSTR s, UINT len, UINT linesize)
//----------------------------------------------------------------
{
...
UINT HackedCSoundFile::GetRawSongComments(LPSTR s, UINT len, UINT linesize)
//-------------------------------------------------------------------
{
	LPCSTR p = m_lpszSongComments;
	if (!p) return 0;
...
BOOL HackedCSoundFile::SetWaveConfig(UINT nRate,UINT nBits,UINT nChannels,BOOL bMMX)
//----------------------------------------------------------------------------
{
	BOOL bReset = FALSE;
...
BOOL HackedCSoundFile::SetMixConfig(UINT nStereoSeparation, UINT nMaxMixChannels)
//-------------------------------------------------------------------------
{
...
BOOL HackedCSoundFile::SetResamplingMode(UINT nMode)
//--------------------------------------------
{
...
BOOL HackedCSoundFile::SetMasterVolume(UINT nVol, BOOL bAdjustAGC)
//----------------------------------------------------------
{
	if (nVol < 1) nVol = 1;
...
void HackedCSoundFile::SetAGC(BOOL b)
//-----------------------------
{
	if (b)
	{
...
UINT HackedCSoundFile::GetNumPatterns() const
//-------------------------------------
{
	UINT i = 0;
...
UINT HackedCSoundFile::GetNumInstruments() const
//----------------------------------------
{
	UINT n=0;
...
UINT HackedCSoundFile::GetMaxPosition() const
//-------------------------------------
{
	UINT max = 0;
	UINT i = 0;
...
UINT HackedCSoundFile::GetCurrentPos() const
//------------------------------------
{
	UINT pos = 0;
...
void HackedCSoundFile::SetCurrentPos(UINT nPos)
//---------------------------------------
{
	UINT i, nPattern;
...
void HackedCSoundFile::SetCurrentOrder(UINT nPos)
//-----------------------------------------
{
...
void HackedCSoundFile::ResetChannels()
//------------------------------
{
...
void HackedCSoundFile::LoopPattern(int nPat, int nRow)
//----------------------------------------------
{
...
UINT HackedCSoundFile::GetBestSaveFormat() const
//----------------------------------------
{
...
UINT HackedCSoundFile::GetSaveFormats() const
//-------------------------------------
{
	UINT n = 0;
...
UINT HackedCSoundFile::GetSampleName(UINT nSample,LPSTR s) const
//--------------------------------------------------------
{
...
UINT HackedCSoundFile::GetInstrumentName(UINT nInstr,LPSTR s) const
//-----------------------------------------------------------
{
        char sztmp[40] = "";  // changed from CHAR
...
#ifndef NO_PACKING
UINT HackedCSoundFile::PackSample(int &sample, int next)
//------------------------------------------------
{
	UINT i = 0;
...
BOOL HackedCSoundFile::CanPackSample(LPSTR pSample, UINT nLen, UINT nPacking, BYTE *result)
//-----------------------------------------------------------------------------------
{
...
UINT HackedCSoundFile::WriteSample(FILE *f, MODINSTRUMENT *pins, UINT nFlags, UINT nMaxLen)
//-----------------------------------------------------------------------------------
{
	UINT len = 0, bufcount;
...
UINT HackedCSoundFile::ReadSample(MODINSTRUMENT *pIns, UINT nFlags, LPCSTR lpMemFile, DWORD dwMemLength)
//------------------------------------------------------------------------------
{
...
void HackedCSoundFile::AdjustSampleLoop(MODINSTRUMENT *pIns)
//----------------------------------------------------
{
...
DWORD HackedCSoundFile::TransposeToFrequency(int transp, int ftune)
//-----------------------------------------------------------
{
...
int HackedCSoundFile::FrequencyToTranspose(DWORD freq)
//----------------------------------------------
{
...
void HackedCSoundFile::FrequencyToTranspose(MODINSTRUMENT *psmp)
//--------------------------------------------------------
{
...
void HackedCSoundFile::CheckCPUUsage(UINT nCPU)
//---------------------------------------
{
...
BOOL HackedCSoundFile::SetPatternName(UINT nPat, LPCSTR lpszName)
//---------------------------------------------------------
{
...
BOOL HackedCSoundFile::GetPatternName(UINT nPat, LPSTR lpszName, UINT cbSize) const
//---------------------------------------------------------------------------
{
...
UINT HackedCSoundFile::DetectUnusedSamples(BOOL *pbIns)
//-----------------------------------------------
{
	UINT nExt = 0;
...
BOOL HackedCSoundFile::RemoveSelectedSamples(BOOL *pbIns)
//-------------------------------------------------
{
...
BOOL HackedCSoundFile::DestroySample(UINT nSample)
//------------------------------------------
{
