...
UINT HackedCSoundFile::m_nStereoSeparation = 128;
UINT HackedCSoundFile::m_nMaxMixChannels = 32;
LONG HackedCSoundFile::m_nStreamVolume = 0x8000;
// Mixing Configuration (SetWaveConfig)
DWORD HackedCSoundFile::gdwSysInfo = 0;
DWORD HackedCSoundFile::gnChannels = 1;
DWORD HackedCSoundFile::gdwSoundSetup = 0;
DWORD HackedCSoundFile::gdwMixingFreq = 44100;
DWORD HackedCSoundFile::gnBitsPerSample = 16;
// Mixing data initialized in
UINT HackedCSoundFile::gnAGC = AGC_UNITY;
UINT HackedCSoundFile::gnVolumeRampSamples = 64;
UINT HackedCSoundFile::gnVUMeter = 0;
UINT HackedCSoundFile::gnCPUUsage = 0;
LPSNDMIXHOOKPROC HackedCSoundFile::gpSndMixHook = NULL;
PMIXPLUGINCREATEPROC HackedCSoundFile::gpMixPluginCreateProc = NULL;
LONG gnDryROfsVol = 0;
LONG gnDryLOfsVol = 0;
LONG gnRvbROfsVol = 0;
LONG gnRvbLOfsVol = 0;
...
BOOL HackedCSoundFile::InitPlayer(BOOL bReset)
//--------------------------------------
{
	DPRINT("init player");
...
BOOL HackedCSoundFile::FadeSong(UINT msec)
//----------------------------------
{
...
BOOL HackedCSoundFile::GlobalFadeSong(UINT msec)
//----------------------------------------
{
...
UINT HackedCSoundFile::Read(LPVOID lpDestBuffer, UINT cbBuffer)
//-------------------------------------------------------
{
...
BOOL HackedCSoundFile::ProcessRow()
//---------------------------
{
	//cout << "HackedCSoundFile::ProcessRow()" << endl;
...
BOOL HackedCSoundFile::ReadNote()
//-------------------------
{
	//cout << "HackedCSoundFile::readnote" << endl;
	...
	for (UINT nChn=0; nChn<MAX_CHANNELS; nChn++,pChn++)
	{
		...
		if ((enabled_channels[nChn] == false || pChn->dwFlags & CHN_MUTE) || ((nChn >= m_nChannels) && (!pChn->nLength)))
		{
			pChn->nVUMeter = 0;
