...
#else
BOOL HackedCSoundFile::TestABC(const BYTE *lpStream, DWORD dwMemLength)
#endif
// =====================================================================================
{
    char id[128];
...
// =====================================================================================
{
	...
	trillbits = 0; // trill effect admininstration: one bit per channel, max 32 channnels
	for( pat = 0; pat < numpat; pat++ ) {
		pattern[pat] = HackedCSoundFile::AllocatePattern(64, channels);
...
#else
BOOL HackedCSoundFile::ReadABC(const uint8_t *lpStream, DWORD dwMemLength)
#endif
{
