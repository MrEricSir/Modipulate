...
public:	// <Modipulate>
    ...
    // This is the userdata for the callbacks.
    void* mod_stream;
	...
	modplug_hacked_on_tempo_changed_cb on_tempo_changed;
    modplug_hacked_on_note_change_cb on_note_change;
    modplug_hacked_on_pattern_changed_cb on_pattern_changed;
    modplug_hacked_on_row_changed_cb on_row_changed;
...
public:
	...
	//BOOL ReadABC(LPCBYTE lpStream, DWORD dwMemLength); // Had issues with this one on Windows.
...
public:
	...
	BOOL ReadInstrumentFromSong(UINT nInstr, HackedCSoundFile *, UINT nSrcInstrument);
	BOOL ReadSampleFromSong(UINT nSample, HackedCSoundFile *, UINT nSrcSample);
