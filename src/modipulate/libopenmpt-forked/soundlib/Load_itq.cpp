...
// bool CSoundFile::SaveITQ(const mpt::PathString &filename, bool compatibilityExport)
// //--------------------------------------------------------------------------------
// {
...
// 	ITSample itss;
// 	MemsetZero(itss);
// 	//itss.magic = 0x53515449; // #ITQ -- Magic chars "ITQS"
